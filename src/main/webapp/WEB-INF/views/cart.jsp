        ...
        <div class="col-md-12">
            <table class="table table-hover">
                            ...
                            <div class="card">
                                <div class="card-body cart">
                                    <div class="col-sm-12 empty-cart-cls text-center"> <img src="https://i.imgur.com/dCdflKN.png" width="130" height="130" class="img-fluid mb-4 mr-3">
                                        ...
                                        <h4>Add something to make me happy :)</h4> <a href="${pageContext.request.contextPath}/product" class="btn btn-success cart-btn-transform m-3" data-abc="true">continue shopping</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <table class="table table-image">
                    ...
                    <tr>
                        <td class="col-md-3">
                            <img src="${detail.value.product.image1}" class="img-fluid img-thumbnail" alt="Sheep">
                        </td>
                        <td>${detail.value.product.name}</td>
                        <td class="dataPrice">${detail.value.product.price}</td>
                        <td id="qty"><input name="dataQuanlity" onchange="update()" type="text" class="form-control" id="input1" value="${detail.value.quatity}"></td>
                        <td class="dataTotal">${detail.value.total}</td>
                        <td>
                            <form action="${pageContext.request.contextPath}/cart/remove&id=${detail.value.product.id}" method="post">
                ...
                <div class="d-flex justify-content-end" style="width: 32%;float: right; margin-bottom: 2vw;">
                    <h3>Sub Total: <div id="subtotal" style="float: right;" class="price text-success"><b>${cart.updateTotal()}</b></div></h3>
                    <br/>
                    <h3>Estimated Shipping: <div style="float: right;" class="price text-success"><b>10000</b></div></h3>
                    <br/>

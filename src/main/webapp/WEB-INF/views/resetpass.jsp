...
<div class="container" style="margin-top: 4vh">
    <div class="row">
        <div class="col-md-3 col-md-offset-4" >
            <div class="panel panel-default" style="width: 30vw">
                <div class="panel-body">
                    <div class="text-center">
                        ...
                        <div class="panel-body">
                            ...
                            <form id="register-form" action="/resetpassword" role="form" autocomplete="off" class="form" method="post">
                                <input type="hidden" name="email" value="<%=session.getAttribute("emailforget")%>">
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user color-blue"></i></span>
                                        <input name="idforget" placeholder="code" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
